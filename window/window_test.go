...
var windowTests = []windowTest{
	...
	},
	{
		...
		// Written to ten significant figures rather than five. PrettyClose
		// compares to 1e-8, so the five-figure values this row used to hold
		// could never match a correct result — every other row happens to be
		// exact at the precision it is written to, which is why this was the
		// only one failing. Checked against the four-term Blackman-Harris
		// definition, a0 - a1cos(2pin/(N-1)) + a2cos(4pin/(N-1)) -
		// a3cos(6pin/(N-1)), rather than taken from the output.
		[]float64{0.00006, 0.0150711734, 0.1470395579, 0.520575, 0.9316592687, 0.9316592687, 0.520575, 0.1470395579, 0.0150711734, 0.00006},
	},
}
