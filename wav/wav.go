...
func New(r io.Reader) (*Wav, error) {
	...
	for {
		...
		case "data":
			...
			return &w, nil
		default:
			// An unrecognized chunk is skipped. If it cannot be skipped the
			// stream is no longer positioned at a chunk header, so every
			// subsequent read is of whatever happens to be there.
